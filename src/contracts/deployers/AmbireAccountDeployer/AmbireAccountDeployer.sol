...
contract AmbireAccountDeployer {
	...
	function deploy(uint256 tokenId, bytes calldata code) external {
	...
	function deployAndExecute(
		uint256 tokenId, bytes calldata code, uint256 salt,
	...
	function deployAndCall(uint256 tokenId, bytes calldata code, uint256 salt, address callee, bytes calldata data) external {
		deploySafe(tokenId, code);
